...
return view.extend({
	...
	render: function(hosts_duids_pools) {
		...
		o = s.taboption('mac', form.SectionValue, '__mac__', form.TableSection, 'mac', null,
			_('MAC are hardware addresses used to match clients to set tags on them.') + '<br /><br />' +
		...
		o = s.taboption('vc', form.SectionValue, '__vc__', form.TableSection, 'vendorclass', null,
			_('Match Vendor Class (VC) strings sent by clients as a trigger to set tags on them.') + '<br /><br />' +
		...
		o = s.taboption('uc', form.SectionValue, '__uc__', form.TableSection, 'userclass', null,
			_('Match User Class (UC) strings sent by clients as a trigger to set tags on them.') + '<br /><br />' +
